...
import DetailClassListReviewGrade from "../pages/Class/DetailClassListReviewGrade";
  ...
  return (
    <Suspense fallback={<Loading/>}>
      <Routes>
        ...
        <Route exact path={PATH.LIST_GRADE_REVIEW} element={<DetailClassListReviewGrade />} />
